...
public final class FragmentImageBinding implements ViewBinding {
  ...
  private FragmentImageBinding(@NonNull LinearLayout rootView,
      @NonNull ImageView destinationImage) {
  ...
  public static FragmentImageBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.destination_image;
      ImageView destinationImage = ViewBindings.findChildViewById(rootView, id);
      if (destinationImage == null) {
        break missingId;
      }

      return new FragmentImageBinding((LinearLayout) rootView, destinationImage);
    }
